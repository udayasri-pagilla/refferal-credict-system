...
export default function FeatureCard({ title, desc, icon = '/images/icon-referral.svg' }: Props){
  return (
    <div className="bg-white rounded-lg shadow-sm p-5 flex items-start space-x-4 hover:shadow-md transform hover:-translate-y-1 transition-all duration-200 animate-fade-in-up">
